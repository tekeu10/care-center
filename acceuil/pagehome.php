...
<body>
  ...
  <header id="header" class="fixed-top">
    ...
    <img src="assets/img/test.png" alt="" width="50px" height="50px"> 
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#testimonials">Témoignage</a></li>
