...
<body>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  if (isset($_POST['envoyer'])) {
                    ...
                    if ($stmp) {
                      echo ("<script>alert('Demande en cours de traitement. Merci de patienter😊 ')</script>");
                  ...
                  <form class="row g-3" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <select class="form-select" name="jour" id="jour" onchange="selectJourRdv(this.value);"><br>
                    ...
                    <div class="col-12">
                      ...
                      <select class="form-select" name="heure" id="jour">
                        <?php foreach ($data as $j) : ?>
                          <option value="<?= $j["idtemps"] ?>"><?= $j["temps"] ?></option>
                        <?php endforeach ?>
                      </select>
                    </div>
  ...
  <script type="text/javascript">
    ...
    function selectJourRdv(id) {
      jour = document.getElementById('jour').value;

      $('#heureRdv').html('');
      $('#heureRdv').html('<option class="form-select">Veuillez choisir votre heure</option>');
      $.ajax({
        type: 'post',
        url: 'ajax.php',
        data: {
